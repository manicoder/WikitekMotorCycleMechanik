...
namespace APDiagnosticAndroid
{
    public class UDSDiagnostic
    {
        ...
        #region CTOR
        public UDSDiagnostic(APELMDongleComm dongleCommWin)
        {
        ...
        public async Task<string[]> genericOBDSupportedPidList()
        {
            try
            {
                ...
                for (int i = 0; i < 7; i++)
                {
                    ...
                    {
                        if (supportedpid == null || (!supportedpid.Any()))
                        {
                            supportedpid = new string[2];
                            supportedpid[0] = "ERROR";
                            supportedpid[1] = response.ECUResponseStatus;
                            break;
                        }
                    }
                }
